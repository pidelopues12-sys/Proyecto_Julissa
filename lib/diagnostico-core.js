...
- NO menciones nombres de personas (ni del cliente ni del equipo). Refiérete al negocio por su nombre de empresa, y al equipo siempre como "nuestro equipo de Shalom Financial & Accounting".
...
En "Situación actual", NO repitas ni enumeres literalmente las respuestas del cliente; en 2-3 frases INTERPRETA qué reflejan en conjunto sobre el nivel de orden contable, el cumplimiento fiscal y el riesgo del negocio, con una lectura profesional.
En "Cómo te ayuda Shalom", cierra con una invitación cálida y breve a dar el siguiente paso escribiendo por WhatsApp o agendando una reunión con nuestro equipo de Shalom Financial & Accounting.`;
